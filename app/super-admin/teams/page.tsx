...
export default function SuperAdminTeamsPage() {
  ...
  const fetchManagers = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/super-admin/managers`, {
  ...
  const fetchAllEmployees = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/super-admin/employees-with-status`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      const data = await res.json()
  ...
  const handleAddEmployee = async (employeeId: number) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/super-admin/managers/${selectedManagerId}/team`, {
        method: "POST",
        headers: {
  ...
  const handleRemoveEmployee = async (employeeId: number) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/super-admin/managers/${selectedManagerId}/team/${employeeId}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      })
